...
let sortTable = (idTable, data) => {
    ...
    rowData.sort((first, second) => {
        for (let i in sortArr) {
            ...
            if (columnNames[key] === "Высота (м)" || columnNames[key] === "Первое восхождение" || columnNames[key] === "Количество восхождений") {
...
let resetSort = (idTable, dataForm) => {
    ...
    if (filterForm) {
        ...
        filterTable(mountains, idTable, filterForm);
    } else {
        // Иначе просто создаем таблицу с исходными данными
        createTable(mountains, idTable);
    }
};